...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{\imageSrc/external_security_notes.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{\imageSrc/pet_shop_model_1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{\imageSrc/pet_shop_model_2.png}
    \caption{Voorbeeldmodel}
    \label{example2}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{\imageSrc/pet_shop_model_3.png}
    \caption{Voorbeeldmodel}
    \label{example3}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{\imageSrc/STRIDE.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{\imageSrc/spoofing.png}
    \caption{Spoofing}
    \label{spoofing}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{\imageSrc/tampering.png}
    \caption{Tampering}
    \label{tampering}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{\imageSrc/information.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{\imageSrc/dos.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{\imageSrc/eop.png}
